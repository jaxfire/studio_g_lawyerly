...
public class Lawyer {
    ...
    public void setProfile_image_id(int profile_image_id) { this.profile_image_id = profile_image_id; }

    public static ArrayList<Lawyer> generateDummyLawyers(Context context, int quantity){
        ...
        //Include a single favourited lawyer
